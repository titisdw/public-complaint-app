                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) { ?>
                                <tr>
                                    ...
                                    <td><img src="../assets/image/<?php echo $data['foto']; ?>" width="100"></td>
                                    <td>
                                        <?php 
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="" method="POST">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" name="tgl_pengaduan" class="form_control" value="<?php echo $data['tgl_pengaduan'] ?>" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <label for="" class="col-md-4">Judul</label>
                                                                    <div class="col-md-8">
                                                                        <input type="text" name="judul_laporan" class="form_control" value="<?php echo $data['judul_laporan'] ?>" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <label for="" class="col-md-4">Isi</label>
                                                                    <div class="col-md-8">
                                                                        <textarea name="isi_laporan" class="form_control" readonly><?php echo $data['isi_laporan'] ?></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <label for="" class="col-md-4">Foto</label>
                                                                    <div class="col-md-8">
                                                                        <img src="../assets/image/<?php echo $data['foto']; ?>" width="100">
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <label for="" class="col-md-4">Tanggapan</label>
                                                                    <div class="col-md-8">
                                                        ...
                                                        if (isset($_POST['kirim_tanggapan'])) {
                                                            $id_pengaduan = htmlspecialchars($_POST['id_pengaduan']);
                                                            $id_petugas = htmlspecialchars($_SESSION['id_petugas']);
                                                            $tanggal = date("Y-m-d");
